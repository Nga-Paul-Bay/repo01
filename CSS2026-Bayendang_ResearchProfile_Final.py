...
if menu == "Researcher Profile":
    st.write("NOTICE: Depending on your machine/network/web browser, some features might not load/takes long to laod. Please wait/refresh/use a different machine/browser.")
    ...
    st.image(image_paths, caption=captions, width=330) 
    
    st.write(" ")
    captions = ["ResearchGate: https://www.researchgate.net/profile/Nganyang-Bayendang/research"]
    #image_paths = ["https://i.sstatic.net/TxT1R.png"]
    image_paths = ["https://coverimages.igi-global.com/newsroom/research%20gate%20logo.jpg"]
    st.image(image_paths, caption=captions, width=222) 
